...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <div class="input-group" style="margin-bottom: 10px;float: left;width: 160px">
                ...
                <form  method="post" id="addForm" class="form-horizontal">
                    <div class="modal-body">
                        <%--<table align="center">
                            ...
                            <tr>
                                <td align="right">电费：</td>
                                <td align="left">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="数字" name="electricRate">
                                    </div>
                                </td>
                            </tr>
                        </table>--%>
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label">电费</label>
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="数字" name="electricRate">
                                    </div>
...
<script src="${jsPath}/admin/electricRecord.js"></script>
</body>
</html>
