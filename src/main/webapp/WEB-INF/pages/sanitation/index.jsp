...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <div class="input-group" style="margin-bottom: 10px;float: left;width: 150px">
            ...
            <select class="selectpicker" data-size="10" name = "degree"></select>
        </div>
            ...
            <div class="modal-content">
                ...
                <form  method="post" id="addForm" class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label">卫生情况</label>
                            <div class="col-sm-6">
                                <select class="selectpicker" data-size="10" name = "degree"></select>
                            </div>
                        </div>
...
<script src="${jsPath}/admin/sanitation.js"></script>
</body>
</html>
