...
function initModel(){
    $(".modal.fade").on("hide.bs.modal", function(e){
        ...
        $("#table").bootstrapTable("refresh",{url : "/electricRecord/search"});
    })
...
window.operateEvents = {
    'click #edit': function (e, value, row, index) {
        ...
        $("#editModal input[name='electricRate']").val(row.electricRate);
